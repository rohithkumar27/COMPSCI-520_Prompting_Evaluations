    ...
    while queue:
        ...
        for dr, dc in directions:
            ...
            if 0 <= new_r < rows and 0 <= new_c < cols:
                ...
                # If it's an obstacle, increment the count of removed obstacles
                if grid[new_r][new_c] == 1:
                    new_obstacles_removed += 1

                # If we haven't exceeded the maximum allowed obstacle removals
                # and this state (new_r, new_c, new_obstacles_removed) hasn't been visited
                if new_obstacles_removed <= k and (new_r, new_c, new_obstacles_removed) not in visited:

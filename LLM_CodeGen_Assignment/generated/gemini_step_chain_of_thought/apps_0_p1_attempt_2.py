...
def solve_knapsack_variant(n: int, W: int, k: int, items: List[Tuple[int, int]]) -> int:
    ...
    # This implies item indices are 0-based. So type 1 is items[0] and type 2 is items[1].
    # 2 * items[0] = (4, 6)
    # 1 * items[1] = (3, 4)
    # Total weight = 4 + 3 = 7
    # Total value = 6 + 4 = 10.
    # Let's re-evaluate the example's optimal.
    # If we take 2 of item (2,3) and 1 of item (3,4): weight = 2*2 + 3 = 7, value = 2*3 + 4 = 10.
    # If we take 1 of item (
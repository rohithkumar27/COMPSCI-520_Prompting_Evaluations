# Detailed Test Case Analysis: gemini_chain_of_thought

**Generated:** 2025-11-09 14:55:41  
**Attempt:** 1
...
- **Failed:** 2 (16.7%)
- **Total Test Cases:** 40
- **Avg Test Cases per Problem:** 3.3

## 📈 Coverage Summary

- **Overall Coverage:** 28%
- **Total Statements:** 318
- **Missed Statements:** 226
- **Total Branches:** 172
- **Partial Branches:** 2
...
| P1 (HE0) | `test_has_close_elements` | ✅ PASSED | 5 | 100% | 6 |
| P2 (HE1) | `test_separate_paren_groups` | ✅ PASSED | 3 | 96% | 10 |
| P1 (HE2) | `test_truncate_number` | ✅ PASSED | 3 | 100% | 0 |
| P4 (HE3) | `test_below_zero` | ✅ PASSED | 4 | 100% | 4 |
| P5 (HE4) | `test_mean_absolute_deviation` | ✅ PASSED | 3 | 78% | 2 |
...
**Test Cases:** 3  
**Coverage:** 96%  
**Statements:** 18 (Missed: 0)  
**Branches:** 10 (Partial: 1)  
...
### Strengths
- 10 out of 12 problems passed all test cases
- Average of 3.3 test cases per problem
- Overall code coverage: 28%
...
**HTML Report:** `coverage_reports/gemini_chain_of_thought_attempt1/html/index.html`
